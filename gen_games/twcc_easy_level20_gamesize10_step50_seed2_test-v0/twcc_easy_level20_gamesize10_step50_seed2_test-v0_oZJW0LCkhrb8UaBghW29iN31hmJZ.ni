...
The r_10 and the r_9 and the r_11 and the r_12 and the r_14 and the r_13 and the r_16 and the r_15 and the r_19 and the r_18 and the r_2 and the r_1 and the r_5 and the r_6 and the r_0 and the r_17 and the r_3 and the r_4 and the r_7 and the r_8 are rooms.
...
The playroom part 0 is some text that varies. The playroom part 0 is "Well, here we are in the playroom. You start to take note of what's in the room.
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "Okay, so you're in a laundromat, cool, but is it typical? You better believe it is.
...
The parlor part 0 is some text that varies. The parlor part 0 is "You find yourself in a parlor. An ordinary one. You begin to take stock of what's here.
...
The r_10 and the r_9 and the r_11 and the r_12 and the r_14 and the r_13 and the r_16 and the r_15 and the r_19 and the r_18 and the r_2 and the r_1 and the r_5 and the r_6 and the r_0 and the r_17 and the r_3 and the r_4 and the r_7 and the r_8 are rooms.
The r_10 and the r_9 and the r_11 and the r_12 and the r_14 and the r_13 and the r_16 and the r_15 and the r_19 and the r_18 and the r_2 and the r_1 and the r_5 and the r_6 and the r_0 and the r_17 and the r_3 and the r_4 and the r_7 and the r_8 are privately-named.
...
Test quest0 with "go south / go east / go south / go south / go south / go west / go south / go south / go south / go east / go north / go west / go north / go east / go north / go east / go south / go south / go east / take coin"
...
Rule for printing the banner text:
	say "Welcome to another exciting session of TextWorld! recover the coin from the playroom.[line break]".
...
An objective is some text that varies. The objective is "Welcome to another exciting session of TextWorld! recover the coin from the playroom.".

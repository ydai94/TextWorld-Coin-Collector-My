...
The r_1 and the r_2 and the r_5 and the r_4 and the r_7 and the r_6 and the r_0 and the r_3 and the r_8 and the r_9 are rooms.
...
The studio part 0 is some text that varies. The studio part 0 is "You find yourself in a studio. A typical one. You can barely contain your excitement.
...
The playroom part 0 is some text that varies. The playroom part 0 is "You find yourself in a playroom. A normal kind of place. The room is well lit.
...
The r_1 and the r_2 and the r_5 and the r_4 and the r_7 and the r_6 and the r_0 and the r_3 and the r_8 and the r_9 are rooms.
The r_1 and the r_2 and the r_5 and the r_4 and the r_7 and the r_6 and the r_0 and the r_3 and the r_8 and the r_9 are privately-named.
...
Test quest0 with "go south / go west / go north / go north / go east / go north / go east / go north / go north / take coin"
...
Rule for printing the banner text:
	say "Your objective is to recover the coin that's in the workshop.[line break]".
...
An objective is some text that varies. The objective is "Your objective is to recover the coin that's in the workshop.".

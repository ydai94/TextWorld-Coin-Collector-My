...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You've seen better bedchambers, but at least this one seems pretty typical. Okay, just remember what you're here to do, and everything will go great.
...
The launderette part 0 is some text that varies. The launderette part 0 is "You have stumbled into a launderette. Not the launderette you'd expect. No, this is a launderette. I guess you better just go and list everything you see here.
...
Test quest0 with "go east / go east / go east / go east / go south / go east / go north / go east / go south / take coin"
...
Rule for printing the banner text:
	say "Welcome to another life changing episode of TextWorld! retrieve the coin in the vault.[line break]".
...
An objective is some text that varies. The objective is "Welcome to another life changing episode of TextWorld! retrieve the coin in the vault.".

...
The playroom part 0 is some text that varies. The playroom part 0 is "Okay, so you're in a playroom, cool, but is it usual? You better believe it is. You start to take note of what's in the room.
...
The garage part 0 is some text that varies. The garage part 0 is "You arrive in a garage. A typical one. You begin looking for stuff.
...
The basement part 0 is some text that varies. The basement part 0 is "You are in a basement. An ordinary kind of place. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
Test quest0 with "go south / go west / go south / go west / go west / go north / go west / go west / go west / take coin"
...
Rule for printing the banner text:
	say "Hey, thanks for coming over to TextWorld! Please take the coin from the kitchenette.[line break]".
...
An objective is some text that varies. The objective is "Hey, thanks for coming over to TextWorld! Please take the coin from the kitchenette.".

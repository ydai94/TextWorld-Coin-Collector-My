...
The r_1 and the r_0 and the r_2 and the r_3 and the r_5 and the r_4 and the r_7 and the r_6 and the r_9 and the r_8 are rooms.
...
The lounge part 0 is some text that varies. The lounge part 0 is "You find yourself in a lounge. A typical kind of place. Okay, just remember what you're here to do, and everything will go great.
...
The vault part 0 is some text that varies. The vault part 0 is "I never took you for the sort of person who would show up in a vault, but I guess I was wrong. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The r_1 and the r_0 and the r_2 and the r_3 and the r_5 and the r_4 and the r_7 and the r_6 and the r_9 and the r_8 are rooms.
The r_1 and the r_0 and the r_2 and the r_3 and the r_5 and the r_4 and the r_7 and the r_6 and the r_9 and the r_8 are privately-named.
...
Test quest0 with "go east / go south / go west / go north / go east / go north / go east / go south / go east / take coin"
...
Rule for printing the banner text:
	say "Your objective is to pick up the coin that's in the bedchamber.[line break]".
...
An objective is some text that varies. The objective is "Your objective is to pick up the coin that's in the bedchamber.".

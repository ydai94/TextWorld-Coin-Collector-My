...
Test quest0 with "go south / go west / go south / go east / go south / go east / go south / go south / go east / take coin"
...
Rule for printing the banner text:
	say "Your objective is to take the coin that's in the studio.[line break]".
...
An objective is some text that varies. The objective is "Your objective is to take the coin that's in the studio.".

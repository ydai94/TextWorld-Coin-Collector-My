...
The r_2 and the r_3 and the r_0 and the r_1 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 are rooms.
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You arrive in a standard kind of place. That is to say, you're in a laundromat. You begin to take stock of what's here.
...
The lounge part 0 is some text that varies. The lounge part 0 is "You are in a lounge. It seems to be pretty typical here.
...
The r_2 and the r_3 and the r_0 and the r_1 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 are rooms.
The r_2 and the r_3 and the r_0 and the r_1 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 are privately-named.
...
Test quest0 with "go south / go south / go west / go south / go south / go south / go south / go south / go south / take coin"
...
Rule for printing the banner text:
	say "Your objective is to pick up the coin that's in the kitchen.[line break]".
...
An objective is some text that varies. The objective is "Your objective is to pick up the coin that's in the kitchen.".

...
The r_1 and the r_2 and the r_3 and the r_4 and the r_6 and the r_5 and the r_8 and the r_7 and the r_9 and the r_0 are rooms.
...
The vault part 0 is some text that varies. The vault part 0 is "You find yourself in a vault. An ordinary one. I guess you better just go and list everything you see here.
...
The r_1 and the r_2 and the r_3 and the r_4 and the r_6 and the r_5 and the r_8 and the r_7 and the r_9 and the r_0 are rooms.
The r_1 and the r_2 and the r_3 and the r_4 and the r_6 and the r_5 and the r_8 and the r_7 and the r_9 and the r_0 are privately-named.
...
Test quest0 with "go north / go west / go south / go west / go north / go east / go south / go east / go east / take coin"
...
Rule for printing the banner text:
	say "Welcome to another life changing episode of TextWorld! take the coin in the vault.[line break]".
...
An objective is some text that varies. The objective is "Welcome to another life changing episode of TextWorld! take the coin in the vault.".

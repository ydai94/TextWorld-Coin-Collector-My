...
The launderette part 0 is some text that varies. The launderette part 0 is "You find yourself in a launderette. A normal one. You begin to take stock of what's in the room.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "Of every cubicle you could have shown up in, you had to saunter into a typical one. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
Test quest0 with "go south / go west / go west / go west / take coin"
...
Rule for printing the banner text:
	say "Your objective is to retrieve the coin in the bedroom.[line break]".
...
An objective is some text that varies. The objective is "Your objective is to retrieve the coin in the bedroom.".

...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You've just sauntered into a kitchenette. You begin looking for stuff.
...
The closet part 0 is some text that varies. The closet part 0 is "You find yourself in a closet. An usual kind of place. Let's see what's in here.
...
Test quest0 with "go east / go east / go north / go west / take coin"
...
Rule for printing the banner text:
	say "You are now playing a life changing episode of TextWorld! recover the coin that's in the recreation zone.[line break]".
...
An objective is some text that varies. The objective is "You are now playing a life changing episode of TextWorld! recover the coin that's in the recreation zone.".

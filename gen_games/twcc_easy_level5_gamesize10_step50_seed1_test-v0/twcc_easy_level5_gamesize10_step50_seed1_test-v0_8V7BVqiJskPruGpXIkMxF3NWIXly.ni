...
Rule for printing the banner text:
	say "Welcome to another exciting session of TextWorld! Your task for today is to retrieve the coin in the cubicle.[line break]".
...
An objective is some text that varies. The objective is "Welcome to another exciting session of TextWorld! Your task for today is to retrieve the coin in the cubicle.".

...
The studio part 0 is some text that varies. The studio part 0 is "You have fallen into a studio. Not the studio you'd expect. No, this is a studio.
...
Test quest0 with "go north / go east / go east / go south / take coin"
...
Rule for printing the banner text:
	say "You are now playing a fast paced session of TextWorld! Your task for today is to pick up the coin that's in the launderette.[line break]".
...
An objective is some text that varies. The objective is "You are now playing a fast paced session of TextWorld! Your task for today is to pick up the coin that's in the launderette.".

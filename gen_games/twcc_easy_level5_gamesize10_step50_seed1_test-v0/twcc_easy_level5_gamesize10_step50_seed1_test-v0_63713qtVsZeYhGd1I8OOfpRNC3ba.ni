...
Test quest0 with "go south / go south / go west / go north / take coin"
...
Rule for printing the banner text:
	say "Who's got a virtual machine and is about to play through an fast paced round of TextWorld? You do! pick up the coin in the vault.[line break]".
...
An objective is some text that varies. The objective is "Who's got a virtual machine and is about to play through an fast paced round of TextWorld? You do! pick up the coin in the vault.".

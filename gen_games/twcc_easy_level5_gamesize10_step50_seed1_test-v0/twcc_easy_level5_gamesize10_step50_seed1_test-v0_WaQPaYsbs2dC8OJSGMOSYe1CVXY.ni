...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "If you're wondering why everything seems so usual all of a sudden, it's because you've just shown up in the kitchenette.
...
The cookery part 0 is some text that varies. The cookery part 0 is "You are in a cookery. A typical one. Let's see what's in here.
...
Test quest0 with "go west / go west / go north / go west / take coin"
...
Rule for printing the banner text:
	say "Welcome to another fast paced game of TextWorld! Your task for today is to pick up the coin from the cookery.[line break]".
...
An objective is some text that varies. The objective is "Welcome to another fast paced game of TextWorld! Your task for today is to pick up the coin from the cookery.".

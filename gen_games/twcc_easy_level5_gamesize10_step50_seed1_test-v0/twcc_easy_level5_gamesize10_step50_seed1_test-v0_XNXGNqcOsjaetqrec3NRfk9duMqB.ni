...
The salon part 0 is some text that varies. The salon part 0 is "Okay, so you're in a salon, cool, but is it ordinary? You better believe it is. You start to take note of what's in the room.
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "Of every dish-pit you could have sauntered into, you had to walk into a normal one.
...
The restroom part 0 is some text that varies. The restroom part 0 is "You have fallen into a restroom. Not the restroom you'd expect. No, this is a restroom. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The sauna part 0 is some text that varies. The sauna part 0 is "You are in a sauna. A normal one. Okay, just remember what you're here to do, and everything will go great.
...
Test quest0 with "go east / go east / go north / go north / take coin"
...
Rule for printing the banner text:
	say "I hope your ready to go into rooms and interact with objects, because you've just entered TextWorld! retrieve the coin from the floor of the sauna.[line break]".
...
An objective is some text that varies. The objective is "I hope your ready to go into rooms and interact with objects, because you've just entered TextWorld! retrieve the coin from the floor of the sauna.".

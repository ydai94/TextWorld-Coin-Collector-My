...
The workshop part 0 is some text that varies. The workshop part 0 is "You're not going to believe this, but you've just entered a workshop. I guess you better just go and list everything you see here.
...
The canteen part 0 is some text that varies. The canteen part 0 is "You've just sauntered into a canteen. Okay, just remember what you're here to do, and everything will go great.
...
Rule for printing the banner text:
	say "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! recover the coin in the scullery.[line break]".
...
An objective is some text that varies. The objective is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! recover the coin in the scullery.".

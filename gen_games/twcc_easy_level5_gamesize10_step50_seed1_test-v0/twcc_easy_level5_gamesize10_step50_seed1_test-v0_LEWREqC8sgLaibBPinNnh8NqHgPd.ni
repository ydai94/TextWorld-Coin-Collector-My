...
The office part 0 is some text that varies. The office part 0 is "Look at that placard! What does it say? It says Welcome to the office? Well that's cool. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
Test quest0 with "go west / go north / go east / go east / take coin"
...
Rule for printing the banner text:
	say "It's time to explore the amazing world of TextWorld! take the coin in the study.[line break]".
...
An objective is some text that varies. The objective is "It's time to explore the amazing world of TextWorld! take the coin in the study.".

...
The r_0 and the r_1 and the r_2 and the r_10 and the r_9 and the r_5 and the r_4 and the r_6 and the r_7 and the r_8 and the r_11 and the r_12 and the r_13 and the r_14 and the r_3 are rooms.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "Well, here we are in a kitchenette. The room is well lit.
...
The study part 0 is some text that varies. The study part 0 is "You find yourself in a study. A standard kind of place. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The r_0 and the r_1 and the r_2 and the r_10 and the r_9 and the r_5 and the r_4 and the r_6 and the r_7 and the r_8 and the r_11 and the r_12 and the r_13 and the r_14 and the r_3 are rooms.
The r_0 and the r_1 and the r_2 and the r_10 and the r_9 and the r_5 and the r_4 and the r_6 and the r_7 and the r_8 and the r_11 and the r_12 and the r_13 and the r_14 and the r_3 are privately-named.
...
Test quest0 with "go west / go west / go south / go south / go east / go east / go east / go north / go east / go east / go north / go north / go north / go north / take coin"
...
Rule for printing the banner text:
	say "Hey, thanks for coming over to TextWorld! Please retrieve the coin from the garage.[line break]".
...
An objective is some text that varies. The objective is "Hey, thanks for coming over to TextWorld! Please retrieve the coin from the garage.".

...
The r_2 and the r_1 and the r_3 and the r_6 and the r_5 and the r_7 and the r_8 and the r_9 and the r_0 and the r_4 are rooms.
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You are in a bedchamber. A standard kind of place. You begin looking for stuff.
...
The r_2 and the r_1 and the r_3 and the r_6 and the r_5 and the r_7 and the r_8 and the r_9 and the r_0 and the r_4 are rooms.
The r_2 and the r_1 and the r_3 and the r_6 and the r_5 and the r_7 and the r_8 and the r_9 and the r_0 and the r_4 are privately-named.
...
Test quest0 with "go south / go east / go east / go north / go north / go east / go north / go west / go west / take coin"
...
Rule for printing the banner text:
	say "Your objective is to retrieve the coin that's in the shower.[line break]".
...
An objective is some text that varies. The objective is "Your objective is to retrieve the coin that's in the shower.".

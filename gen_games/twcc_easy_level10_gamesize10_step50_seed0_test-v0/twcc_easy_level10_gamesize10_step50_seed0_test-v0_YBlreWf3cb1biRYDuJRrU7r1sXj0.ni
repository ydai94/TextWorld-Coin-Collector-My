...
The r_0 and the r_1 and the r_2 and the r_3 and the r_4 and the r_6 and the r_5 and the r_7 and the r_8 and the r_9 are rooms.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Okay, so you're in a bedroom, cool, but is it standard? You better believe it is. Okay, just remember what you're here to do, and everything will go great.
...
The r_0 and the r_1 and the r_2 and the r_3 and the r_4 and the r_6 and the r_5 and the r_7 and the r_8 and the r_9 are rooms.
The r_0 and the r_1 and the r_2 and the r_3 and the r_4 and the r_6 and the r_5 and the r_7 and the r_8 and the r_9 are privately-named.
...
Test quest0 with "go west / go south / go west / go west / go north / go east / go north / go west / go north / take coin"
...
Rule for printing the banner text:
	say "Your objective is to recover the coin from the bedroom.[line break]".
...
An objective is some text that varies. The objective is "Your objective is to recover the coin from the bedroom.".

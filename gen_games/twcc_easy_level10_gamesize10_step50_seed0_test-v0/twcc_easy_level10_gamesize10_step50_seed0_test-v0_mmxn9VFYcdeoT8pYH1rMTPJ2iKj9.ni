...
The bathroom part 0 is some text that varies. The bathroom part 0 is "I am obligated to announce that you are now in the bathroom. You begin to take stock of what's here.
...
The studio part 0 is some text that varies. The studio part 0 is "You've moved into a standard room. Your mind races to think of what kind of room would be standard. And then it hits you. Of course. You're in the studio.
...
The garage part 0 is some text that varies. The garage part 0 is "Look at that signboard! What does it say? It says Welcome to the garage? Well that's cool.
...
Test quest0 with "go west / go south / go west / go south / go east / go east / go north / go north / go north / take coin"
...
Rule for printing the banner text:
	say "Your objective is to take the coin from the pantry.[line break]".
...
An objective is some text that varies. The objective is "Your objective is to take the coin from the pantry.".

...
The r_1 and the r_2 and the r_5 and the r_4 and the r_8 and the r_7 and the r_0 and the r_3 and the r_6 and the r_9 are rooms.

The internal name of r_1 is "laundromat".
The printed name of r_1 is "-= Laundromat =-".
The laundromat part 0 is some text that varies. The laundromat part 0 is "You find yourself in a laundromat. An usual kind of place. You begin to take stock of what's here.
...
The r_1 and the r_2 and the r_5 and the r_4 and the r_8 and the r_7 and the r_0 and the r_3 and the r_6 and the r_9 are rooms.
The r_1 and the r_2 and the r_5 and the r_4 and the r_8 and the r_7 and the r_0 and the r_3 and the r_6 and the r_9 are privately-named.
...
Test quest0 with "go north / go west / go north / go north / go east / go north / go north / go east / go south / take coin"
...
Rule for printing the banner text:
	say "It's time to explore the amazing world of TextWorld! retrieve the coin from the floor of the shower.[line break]".
...
An objective is some text that varies. The objective is "It's time to explore the amazing world of TextWorld! retrieve the coin from the floor of the shower.".

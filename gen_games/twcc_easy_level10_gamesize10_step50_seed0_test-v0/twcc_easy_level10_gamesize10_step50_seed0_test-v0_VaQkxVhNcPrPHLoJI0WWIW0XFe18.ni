...
The r_1 and the r_2 and the r_4 and the r_3 and the r_5 and the r_6 and the r_7 and the r_8 and the r_0 and the r_9 are rooms.
...
The playroom part 0 is some text that varies. The playroom part 0 is "You've moved into a standard room. Your mind races to think of what kind of room would be standard. And then it hits you. Of course. You're in the playroom.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You've walked into a normal room. Your mind races to think of what kind of room would be normal. And then it hits you. Of course. You're in the bedroom.
...
The r_1 and the r_2 and the r_4 and the r_3 and the r_5 and the r_6 and the r_7 and the r_8 and the r_0 and the r_9 are rooms.
The r_1 and the r_2 and the r_4 and the r_3 and the r_5 and the r_6 and the r_7 and the r_8 and the r_0 and the r_9 are privately-named.
...
Test quest0 with "go south / go west / go north / go east / go north / go west / go west / go west / go north / take coin"
...
Rule for printing the banner text:
	say "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Your task for today is to pick up the coin from the basement.[line break]".
...
An objective is some text that varies. The objective is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Your task for today is to pick up the coin from the basement.".

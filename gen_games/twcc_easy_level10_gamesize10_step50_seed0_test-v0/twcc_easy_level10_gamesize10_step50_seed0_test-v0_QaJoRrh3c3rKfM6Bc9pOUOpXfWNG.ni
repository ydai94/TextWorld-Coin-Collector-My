...
The r_1 and the r_2 and the r_4 and the r_3 and the r_6 and the r_5 and the r_7 and the r_0 and the r_8 and the r_9 are rooms.
...
The study part 0 is some text that varies. The study part 0 is "Of every study you could have shown up in, you had to show up in a standard one. Let's see what's in here.
...
The r_1 and the r_2 and the r_4 and the r_3 and the r_6 and the r_5 and the r_7 and the r_0 and the r_8 and the r_9 are rooms.
The r_1 and the r_2 and the r_4 and the r_3 and the r_6 and the r_5 and the r_7 and the r_0 and the r_8 and the r_9 are privately-named.
...
Test quest0 with "go south / go west / go south / go east / go south / go east / go east / go north / go north / take coin"
...
Rule for printing the banner text:
	say "Your objective is to recover the coin from the study.[line break]".
...
An objective is some text that varies. The objective is "Your objective is to recover the coin from the study.".

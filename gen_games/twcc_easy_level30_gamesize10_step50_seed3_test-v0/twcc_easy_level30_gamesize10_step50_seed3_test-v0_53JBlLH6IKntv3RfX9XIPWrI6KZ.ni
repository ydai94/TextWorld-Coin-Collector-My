...
The r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_15 and the r_16 and the r_19 and the r_18 and the r_2 and the r_1 and the r_22 and the r_21 and the r_23 and the r_24 and the r_25 and the r_26 and the r_6 and the r_5 and the r_8 and the r_9 and the r_0 and the r_17 and the r_20 and the r_27 and the r_28 and the r_29 and the r_3 and the r_4 and the r_7 are rooms.
...
The cellar part 0 is some text that varies. The cellar part 0 is "Okay, so you're in a cellar, cool, but is it standard? You better believe it is. You start to take note of what's in the room.
...
The bar part 0 is some text that varies. The bar part 0 is "You've just shown up in a bar. You begin looking for stuff.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "Okay, so you're in a cookhouse, cool, but is it normal? You better believe it is. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The serious workshop part 0 is some text that varies. The serious workshop part 0 is "You find yourself in a workshop. A serious kind of place. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_15 and the r_16 and the r_19 and the r_18 and the r_2 and the r_1 and the r_22 and the r_21 and the r_23 and the r_24 and the r_25 and the r_26 and the r_6 and the r_5 and the r_8 and the r_9 and the r_0 and the r_17 and the r_20 and the r_27 and the r_28 and the r_29 and the r_3 and the r_4 and the r_7 are rooms.
The r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_15 and the r_16 and the r_19 and the r_18 and the r_2 and the r_1 and the r_22 and the r_21 and the r_23 and the r_24 and the r_25 and the r_26 and the r_6 and the r_5 and the r_8 and the r_9 and the r_0 and the r_17 and the r_20 and the r_27 and the r_28 and the r_29 and the r_3 and the r_4 and the r_7 are privately-named.
...
Test quest0 with "go north / go east / go north / go north / go north / go east / go south / go south / go west / go west / go west / go north / go west / go west / go north / go west / go south / go south / go east / go south / go south / go east / go south / go west / go south / go west / go north / go north / go north / take coin"
...
Rule for printing the banner text:
	say "Hey, thanks for coming over to TextWorld! Please retrieve the coin from the serious study.[line break]".
...
An objective is some text that varies. The objective is "Hey, thanks for coming over to TextWorld! Please retrieve the coin from the serious study.".

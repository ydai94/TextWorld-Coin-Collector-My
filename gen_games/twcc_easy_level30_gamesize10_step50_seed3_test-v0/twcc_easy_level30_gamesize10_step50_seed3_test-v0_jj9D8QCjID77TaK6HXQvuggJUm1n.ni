...
The r_1 and the r_0 and the r_13 and the r_14 and the r_18 and the r_19 and the r_2 and the r_20 and the r_21 and the r_22 and the r_23 and the r_24 and the r_25 and the r_26 and the r_27 and the r_28 and the r_29 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_10 and the r_11 and the r_12 and the r_15 and the r_16 and the r_17 are rooms.
...
The vault part 0 is some text that varies. The vault part 0 is "If you're wondering why everything seems so typical all of a sudden, it's because you've just shown up in the vault. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "If you're wondering why everything seems so usual all of a sudden, it's because you've just sauntered into the bathroom. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The salon part 0 is some text that varies. The salon part 0 is "You arrive in a salon. A typical one. You can barely contain your excitement.
...
The serious studio part 0 is some text that varies. The serious studio part 0 is "You've just walked into a serious studio.
...
The parlor part 0 is some text that varies. The parlor part 0 is "You find yourself in a parlor. An usual one. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The launderette part 0 is some text that varies. The launderette part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a launderette. You start to take note of what's in the room.
...
The description of r_12 is "[silent office part 0]".
...
Test quest0 with "go east / go east / go east / go south / go west / go west / go west / go west / go west / go south / go south / go south / go south / go west / go north / go north / go north / go north / go west / go north / go west / go south / go west / go west / go north / go west / go west / go north / go west / take coin"
...
Rule for printing the banner text:
	say "Hey, thanks for coming over to TextWorld! Please retrieve the coin in the serious studio.[line break]".
...
An objective is some text that varies. The objective is "Hey, thanks for coming over to TextWorld! Please retrieve the coin in the serious studio.".
